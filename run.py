...
# print(Y_train.shape)
X_train = torch.randn(15, 5, 512)
Y_train = torch.randn(20, 5, 512)
# specify model parameters and train
model = lstm_encoder_decoder.Seq2Seq(input_size=X_train.shape[2], hidden_size=15, g_dim=30, h1_dim=512, h2_dim=512)
loss = model.train_model(X_train, Y_train, n_epochs=5, target_len=Y_train.shape[0], batch_size=5,
